...
data_raw                <- file.path(project_root, "01_data/raw")
data_proc               <- file.path(project_root, "01_data/processed")
...
data_enriched_path      <- file.path(data_proc, "04_data_enricheds.rds")
